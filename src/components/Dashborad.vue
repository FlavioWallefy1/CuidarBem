  ...
  <main class="w-screen h-screen bg-black text-white flex p-4 overflow-hidden select-none font-sans box-border">
    ...
    <aside class="w-[280px] h-full flex flex-col p-6 bg-[#0a0a0a] rounded-[40px] border-4 border-zinc-800 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] mr-6 relative shrink-0">
      ...
      <nav class="flex flex-col gap-6 flex-grow relative z-10">
        ...
        <button @click="router.push('/')" @mouseenter="falar('Sair do sistema')" class="mt-auto py-6 text-[#FF0000] font-[1000] text-4xl uppercase border-t-2 border-zinc-900 pt-6 text-left drop-shadow-[0_0_10px_rgba(255,0,0,0.3)]">
          SAIR
        </button>
      </nav>
    </aside>
