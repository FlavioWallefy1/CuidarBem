          ...
          <div class="h-full w-full bg-black rounded-[33px] border-[3px] border-black p-5 flex flex-col justify-between relative overflow-hidden">
            ...
            <div class="z-10 mt-3 flex justify-between items-end">
              ...
              <button 
                ...
                @mouseenter="falar(`Precisa de ajuda com o remédio ${remedio.nome}? aperte esse botão vermelho para ouvir uma explicação simples`)"
                class="bg-[#FF0000] text-white py-2 px-5 rounded-[18px] font-[1000] text-sm uppercase shadow-[0_0_15px_rgba(255,0,0,0.4)] active:scale-95 transition-all border-2 border-black"
              >
                AJUDA
              </button>
            </div>
